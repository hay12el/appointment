...
import Welcome_admin from '../screens/Welcome_admin'
...
export const AdminStackscreen = () => {
    return ( 
        <Stack.Navigator
        initialRouteName="Admin_pannel"
        >
            <Stack.Screen name="Admin_pannel" component={Admin_pannel} options={{headerShown: false}} />
            <Stack.Screen name="Welcome_admin" component={Welcome_admin} options={{headerShown: false}} />
        </Stack.Navigator>
    )
}
